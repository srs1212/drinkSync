...
var Weather = React.createClass({
  ...
  drinkSyncRecommends: function() {
    ...
    if ( icon === 'rainy' || 'snowy' ) {
      return (<View>
                <Text style={styles.textNow}>Step out of the {this.getDayOfWeek()} weather in </Text>
                <Text style={styles.textNow}>{location} and follow DrinkSync's</Text>
                <Text style={styles.textNow}>recommendation to order a:</Text>
              </View>);
    } else if ( temp <= 54 ) {
